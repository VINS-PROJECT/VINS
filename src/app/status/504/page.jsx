...
import { TimerOff, RefreshCcw, Home } from "lucide-react";
  ...
  return (
    ...
    ">
      ...
      <motion.div
        ...
        style={{
          background: `
            radial-gradient(60% 45% at 45% 42%, rgba(255,180,120,0.18) 0%, transparent 70%),
            radial-gradient(55% 40% at 80% 70%, rgba(255,180,120,0.12) 0%, transparent 65%)
          `,
        }}
      />
      ...
      <div className="relative z-10 text-center max-w-md">
        ...
        >
          This can happen during high traffic or slow upstream services.
        </motion.p>
