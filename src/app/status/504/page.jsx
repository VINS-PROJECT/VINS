  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: `
            radial-gradient(circle at 45% 45%, var(--accent)18 0%, transparent 70%),
            radial-gradient(circle at 80% 70%, var(--accent-dark)12 0%, transparent 65%)
          `,
        }}
      />
      ...
      <div className="relative text-center z-10 max-w-md">
        ...
        <TimerOff className="w-16 h-16 mx-auto mb-6 text-[var(--accent)]" />
